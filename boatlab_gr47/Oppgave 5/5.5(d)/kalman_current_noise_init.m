...
figure
subplot(2,1,1)
plot(kalman_current_noise(:,1),kalman_current_noise(:,2), 'r','LineWidth',1); hold on;
plot(kalman_current_noise(:,1),kalman_current_noise(:,3), 'Color',[0 0.75 0.75],'LineWidth',1); hold on;
plot(kalman_current_noise(:,1),kalman_current_noise(:,4), 'b','LineWidth',1); grid on;
