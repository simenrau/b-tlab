...
%% Simulating
sim('kalman_current_disturbances');
...
figure
subplot(2,1,1)
plot(kalman_current_disturbances(:,1),kalman_current_disturbances(:,2), 'r','LineWidth',1); hold on;
plot(kalman_current_disturbances(:,1),kalman_current_disturbances(:,3), 'Color',[0 0.75 0.75],'LineWidth',1); hold on;
plot(kalman_current_disturbances(:,1),kalman_current_disturbances(:,4), 'b','LineWidth',1); grid on;
